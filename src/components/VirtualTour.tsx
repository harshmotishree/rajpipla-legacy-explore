      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-xl mx-auto text-center mb-16">
          ...
          <p className="text-heritage-charcoal/80 fade-in-scroll">
            Take a virtual journey through the hallways, chambers, and gardens of Nilambaug Palace from the comfort of your home
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="rounded-lg overflow-hidden shadow-xl fade-in-scroll">
            <div className="relative pb-[75%] bg-heritage-navy/10">
              <img 
                src="https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?q=80&w=3264" 
                alt="Virtual tour of Nilambaug Palace" 
